...
const tableTitle = [{
  ...
  label: "annualIncome",value: "年预算收入"}, {
  label: "income", value: "本月收入"},{
  label: "income1_7",value: "1-7月累计收入"},{
  label: "completionRate", value: "完成率"
}]
...
const getData = (owner) => {
  axios({
    method: "get",
    url: "http://localhost:8084/leaseMonthly/page",
    params: {page: query.pageIndex, pageSize: 10, owner: owner? owner:null}
  }).then(res => {
